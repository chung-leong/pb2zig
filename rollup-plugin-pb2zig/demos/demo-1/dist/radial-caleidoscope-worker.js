...
const a2 = new Uint8Array([ 45, 67, 28, 235, 226, 54, 26, 63 ]);
const a3 = new Uint8Array([ 144, 30, 16, 0 ]);
const a4 = new Uint8Array([ 216, 15, 73, 64 ]);
const a5 = new Uint8Array([ 136, 30, 16, 0 ]);
const a6 = new Uint8Array([ 83, 180, 195, 118, 47, 27, 228, 63 ]);
Object.assign(s16, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 0.0001, comptime maxValue: f32 = 3.141592025756836, comptime defaultValue: comptime_float = 0.628318531}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s17, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 0.0001, comptime maxValue: f32 = 3.141592025756836, comptime defaultValue: comptime_float = 0.628318531}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a10 = new Uint8Array([ 120, 30, 16, 0 ]);
const a11 = new Uint8Array([ 219, 15, 201, 64 ]);
const a12 = new Uint8Array([ 112, 30, 16, 0 ]);
Object.assign(s18, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: f32 = 6.2831854820251465, comptime defaultValue: comptime_float = 0.0001}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s19, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: f32 = 6.2831854820251465, comptime defaultValue: comptime_float = 0.0001}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a14 = new Uint8Array([ 88, 30, 16, 0 ]);
const a15 = new Uint8Array([ 92, 143, 194, 245, 40, 0, 127, 64 ]);
const a16 = new Uint8Array([ 88, 30, 16, 0 ]);
Object.assign(s22, {
  ...s,
  type: 2,
  name: "struct{comptime comptime_float = 496.01, comptime comptime_float = 496.01}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s23, {
  ...s,
  type: 11,
  name: "*const struct{comptime comptime_float = 496.01, comptime comptime_float = 496.01}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a19 = new Uint8Array([ 184, 30, 133, 235, 81, 192, 98, 64 ]);
const a20 = new Uint8Array([ 80, 30, 16, 0 ]);
Object.assign(s24, {
  ...s,
  type: 2,
  name: "struct{comptime comptime_float = 150.01, comptime comptime_float = 150.01}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s25, {
  ...s,
  type: 11,
  name: "*const struct{comptime comptime_float = 150.01, comptime comptime_float = 150.01}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a23 = new Uint8Array([ 10, 215, 35, 60, 10, 215, 35, 60 ]);
...
Object.assign(s26, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = @Vector(2, f32), comptime minValue: @Vector(2, f32) = .{ 0.009999999776482582, 0.009999999776482582 }, comptime maxValue: struct{comptime comptime_float = 496.01, comptime comptime_float = 496.01} = .{496.01, 496.01}, comptime defaultValue: struct{comptime comptime_float = 150.01, comptime comptime_float = 150.01} = .{150.01, 150.01}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s27, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = @Vector(2, f32), comptime minValue: @Vector(2, f32) = .{ 0.009999999776482582, 0.009999999776482582 }, comptime maxValue: struct{comptime comptime_float = 496.01, comptime comptime_float = 496.01} = .{496.01, 496.01}, comptime defaultValue: struct{comptime comptime_float = 150.01, comptime comptime_float = 150.01} = .{150.01, 150.01}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s29, {
  ...s,
  type: 11,
  name: "*const struct{comptime angle: struct{comptime type: type = f32, comptime minValue: comptime_float = 0.0001, comptime maxValue: f32 = 3.141592025756836, comptime defaultValue: comptime_float = 0.628318531} = .{.type = f32, .minValue = 0.0001, .maxValue = 3.141592025756836, .defaultValue = 0.628318531}, comptime direction: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: f32 = 6.2831854820251465, comptime defaultValue: comptime_float = 0.0001} = .{.type = f32, .minValue = 0, .maxValue = 6.2831854820251465, .defaultValue = 0.0001}, comptime basepoint: struct{comptime type: type = @Vector(2, f32), comptime minValue: @Vector(2, f32) = .{ 0.009999999776482582, 0.009999999776482582 }, comptime maxValue: struct{comptime comptime_float = 496.01, comptime comptime_float = 496.01} = .{496.01, 496.01}, comptime defaultValue: struct{comptime comptime_float = 150.01, comptime comptime_float = 150.01} = .{150.01, 150.01}} = .{.type = @Vector(2, f32), .minValue = .{ 0.009999999776482582, 0.009999999776482582 }, .maxValue = .{496.01, 496.01}, .defaultValue = .{150.01, 150.01}}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a40 = new Uint8Array([ 32, 55, 16, 0 ]);
const a41 = new Uint8Array([ 197, 54, 16, 0 ]);
const a42 = new Uint8Array([ 82, 97, 100, 105, 97, 108, 67, 97, 108, 101, 105, 100, 111, 115, 99, 111, 112, 101, 0 ]);
const a43 = new Uint8Array([ 28, 55, 16, 0 ]);
const a44 = new Uint8Array([ 172, 54, 16, 0 ]);
const a45 = new Uint8Array([ 80, 101, 116, 114, 105, 32, 76, 101, 115, 107, 105, 110, 101, 110, 0 ]);
const a46 = new Uint8Array([ 24, 55, 16, 0 ]);
const a47 = new Uint8Array([ 1, 0, 0, 0 ]);
const a48 = new Uint8Array([ 20, 55, 16, 0 ]);
const a49 = new Uint8Array([ 114, 54, 16, 0 ]);
const a50 = new Uint8Array([ 67, 97, 108, 101, 105, 100, 111, 115, 99, 111, 112, 101, 32, 45, 101, 102, 102, 101, 99, 116, 32, 102, 111, 114, 32, 114, 97, 100, 105, 97, 108, 32, 114, 101, 102, 108, 101, 99, 116, 105, 111, 110, 0 ]);
...
Object.assign(s36, {
  ...s,
  type: 2,
  name: "radial-caleidoscope.kernel",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s41, {
  ...s,
  type: 9,
  name: "radial-caleidoscope.ColorSpace",
  length: 1,
  byteSize: 1,
  align: 0,
  instance: {
...
const a57 = new Uint8Array([ 96, 30, 16, 0 ]);
Object.assign(s45, {
  ...s,
  type: 2,
  name: "radial-caleidoscope.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "radial-caleidoscope.KernelInput(u8,radial-caleidoscope.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a64 = new Uint8Array([ 96, 30, 16, 0 ]);
Object.assign(s49, {
  ...s,
  type: 2,
  name: "radial-caleidoscope.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "radial-caleidoscope.KernelOutput(u8,radial-caleidoscope.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a68 = new Uint8Array([ 143, 2, 22, 67, 143, 2, 22, 67, 124, 217, 32, 63, 23, 183, 209, 56 ]);
Object.assign(s51, {
  ...s,
  type: 2,
  name: "radial-caleidoscope.KernelParameters(radial-caleidoscope.kernel)",
  length: 1,
  byteSize: 16,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(radial-caleidoscope.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(radial-caleidoscope.createOutput)).Fn.return_type.?).ErrorUnion.error_set!radial-caleidoscope.KernelOutput(u8,radial-caleidoscope.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(radial-caleidoscope.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(radial-caleidoscope.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!radial-caleidoscope.KernelOutput(u8,radial-caleidoscope.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_dbe2e40d;
  return fetch(url);
})();
