...
const a37 = new Uint8Array([ 84, 117, 110, 110, 101, 108, 32, 52, 0 ]);
...
const a45 = new Uint8Array([ 84, 117, 110, 110, 101, 108, 32, 101, 102, 102, 101, 99, 116, 32, 52, 0 ]);
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "tunnel4.KernelInput(u8,tunnel4.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "tunnel4.KernelOutput(u8,tunnel4.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "tunnel4.KernelParameters(tunnel4.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel4.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel4.createOutput)).Fn.return_type.?).ErrorUnion.error_set!tunnel4.KernelOutput(u8,tunnel4.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel4.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel4.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!tunnel4.KernelOutput(u8,tunnel4.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_91b41f33;
  return fetch(url);
})();
