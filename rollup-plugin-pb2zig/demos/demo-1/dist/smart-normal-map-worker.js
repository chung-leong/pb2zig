...
const a3 = new Uint8Array([ 172, 2, 16, 0 ]);
const a4 = new Uint8Array([ 1, 0, 0, 0 ]);
const a5 = new Uint8Array([ 168, 2, 16, 0 ]);
Object.assign(s12, {
  ...s,
  type: 2,
...
const a9 = new Uint8Array([ 152, 2, 16, 0 ]);
const a10 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 20, 64 ]);
const a11 = new Uint8Array([ 136, 2, 16, 0 ]);
...
const a15 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 240, 191 ]);
const a16 = new Uint8Array([ 136, 2, 16, 0 ]);
const a17 = new Uint8Array([ 136, 2, 16, 0 ]);
Object.assign(s19, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = -1, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 1}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s20, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = -1, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 1}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s21, {
  ...s,
  type: 2,
  name: "struct{comptime soft_sobel: struct{comptime type: type = i32, comptime minValue: comptime_int = 0, comptime maxValue: comptime_int = 1, comptime defaultValue: comptime_int = 0} = .{.type = i32, .minValue = 0, .maxValue = 1, .defaultValue = 0}, comptime amount: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 5, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = 0, .maxValue = 5, .defaultValue = 1}, comptime invert_red: struct{comptime type: type = f32, comptime minValue: comptime_float = -1, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = -1, .maxValue = 1, .defaultValue = 1}, comptime invert_green: struct{comptime type: type = f32, comptime minValue: comptime_float = -1, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = -1, .maxValue = 1, .defaultValue = 1}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s22, {
  ...s,
  type: 11,
  name: "*const struct{comptime soft_sobel: struct{comptime type: type = i32, comptime minValue: comptime_int = 0, comptime maxValue: comptime_int = 1, comptime defaultValue: comptime_int = 0} = .{.type = i32, .minValue = 0, .maxValue = 1, .defaultValue = 0}, comptime amount: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 5, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = 0, .maxValue = 5, .defaultValue = 1}, comptime invert_red: struct{comptime type: type = f32, comptime minValue: comptime_float = -1, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = -1, .maxValue = 1, .defaultValue = 1}, comptime invert_green: struct{comptime type: type = f32, comptime minValue: comptime_float = -1, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = -1, .maxValue = 1, .defaultValue = 1}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a33 = new Uint8Array([ 136, 22, 16, 0 ]);
const a34 = new Uint8Array([ 48, 22, 16, 0 ]);
const a35 = new Uint8Array([ 99, 111, 109, 46, 115, 109, 97, 114, 116, 112, 97, 103, 101, 46, 102, 105, 108, 116, 101, 114, 115, 0 ]);
const a36 = new Uint8Array([ 132, 22, 16, 0 ]);
const a37 = new Uint8Array([ 3, 22, 16, 0 ]);
const a38 = new Uint8Array([ 115, 109, 97, 114, 116, 45, 112, 97, 103, 101, 46, 110, 101, 116, 32, 45, 32, 74, 97, 110, 45, 67, 46, 32, 70, 114, 105, 115, 99, 104, 109, 117, 116, 104, 0 ]);
const a39 = new Uint8Array([ 172, 2, 16, 0 ]);
const a40 = new Uint8Array([ 128, 22, 16, 0 ]);
const a41 = new Uint8Array([ 191, 21, 16, 0 ]);
const a42 = new Uint8Array([ 71, 101, 110, 101, 114, 97, 116, 101, 115, 32, 97, 32, 110, 111, 114, 109, 97, 108, 109, 97, 112, 32, 117, 115, 105, 110, 103, 32, 99, 111, 110, 100, 101, 110, 115, 101, 100, 32, 111, 114, 32, 115, 111, 98, 101, 108, 45, 101, 100, 103, 101, 46, 0 ]);
...
Object.assign(s34, {
  ...s,
  type: 9,
  name: "smart-normal-map.ColorSpace",
  length: 1,
  byteSize: 1,
  align: 0,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 2,
  name: "smart-normal-map.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s39, {
  ...s,
  type: 2,
  name: "smart-normal-map.KernelInput(u8,smart-normal-map.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a56 = new Uint8Array([ 128, 2, 16, 0 ]);
Object.assign(s42, {
  ...s,
  type: 2,
  name: "smart-normal-map.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s43, {
  ...s,
  type: 2,
  name: "smart-normal-map.KernelOutput(u8,smart-normal-map.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a60 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 128, 63, 0, 0, 128, 63, 0, 0, 128, 63 ]);
Object.assign(s44, {
  ...s,
  type: 2,
  name: "smart-normal-map.KernelParameters(smart-normal-map.kernel)",
  length: 1,
  byteSize: 16,
  instance: {
    members: [
...
Object.assign(s45, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(smart-normal-map.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s46, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(smart-normal-map.createOutput)).Fn.return_type.?).ErrorUnion.error_set!smart-normal-map.KernelOutput(u8,smart-normal-map.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s48, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(smart-normal-map.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s49, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(smart-normal-map.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!smart-normal-map.KernelOutput(u8,smart-normal-map.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_ed2fbbfd;
  return fetch(url);
})();
