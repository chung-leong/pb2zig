...
const a3 = new Uint8Array([ 160, 2, 16, 0 ]);
const a4 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 52, 64 ]);
const a5 = new Uint8Array([ 144, 2, 16, 0 ]);
...
const a11 = new Uint8Array([ 154, 153, 153, 153, 153, 153, 185, 63 ]);
Object.assign(s14, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 0.1}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s15, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 0.1}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s16, {
  ...s,
  type: 2,
  name: "struct{comptime amount: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 20, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = 0, .maxValue = 20, .defaultValue = 1}, comptime radius: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 0.1} = .{.type = f32, .minValue = 0, .maxValue = 1, .defaultValue = 0.1}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s17, {
  ...s,
  type: 11,
  name: "*const struct{comptime amount: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 20, comptime defaultValue: comptime_float = 1} = .{.type = f32, .minValue = 0, .maxValue = 20, .defaultValue = 1}, comptime radius: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 1, comptime defaultValue: comptime_float = 0.1} = .{.type = f32, .minValue = 0, .maxValue = 1, .defaultValue = 0.1}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a18 = new Uint8Array([ 4, 0, 0, 0 ]);
Object.assign(s18, {
  ...s,
  type: 2,
...
const a25 = new Uint8Array([ 76, 16, 16, 0 ]);
const a26 = new Uint8Array([ 5, 16, 16, 0 ]);
const a27 = new Uint8Array([ 99, 111, 109, 46, 114, 112, 104, 101, 108, 97, 110, 0 ]);
const a28 = new Uint8Array([ 72, 16, 16, 0 ]);
const a29 = new Uint8Array([ 239, 15, 16, 0 ]);
const a30 = new Uint8Array([ 82, 121, 97, 110, 32, 80, 104, 101, 108, 97, 110, 0 ]);
const a31 = new Uint8Array([ 68, 16, 16, 0 ]);
const a32 = new Uint8Array([ 1, 0, 0, 0 ]);
const a33 = new Uint8Array([ 64, 16, 16, 0 ]);
const a34 = new Uint8Array([ 186, 15, 16, 0 ]);
const a35 = new Uint8Array([ 65, 112, 112, 108, 105, 101, 115, 32, 97, 32, 115, 104, 97, 114, 112, 101, 110, 32, 101, 102, 102, 101, 99, 116, 32, 116, 111, 32, 97, 110, 32, 105, 109, 97, 103, 101, 46, 0 ]);
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "sharpen.KernelInput(u8,sharpen.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 2,
  name: "sharpen.KernelOutput(u8,sharpen.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a53 = new Uint8Array([ 0, 0, 128, 63, 205, 204, 204, 61 ]);
Object.assign(s39, {
  ...s,
  type: 2,
  name: "sharpen.KernelParameters(sharpen.kernel)",
  length: 1,
  byteSize: 8,
  instance: {
    members: [
...
Object.assign(s40, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(sharpen.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s41, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(sharpen.createOutput)).Fn.return_type.?).ErrorUnion.error_set!sharpen.KernelOutput(u8,sharpen.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s43, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(sharpen.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s44, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(sharpen.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!sharpen.KernelOutput(u8,sharpen.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_3acf8799;
  return fetch(url);
})();
