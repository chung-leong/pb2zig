...
const a4 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 176, 64 ]);
const a5 = new Uint8Array([ 56, 30, 16, 0 ]);
Object.assign(s15, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 4096, comptime defaultValue: comptime_float = 0}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s16, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 4096, comptime defaultValue: comptime_float = 0}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s17, {
  ...s,
  type: 2,
  name: "struct{comptime center: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 4096, comptime defaultValue: comptime_float = 0} = .{.type = f32, .minValue = 0, .maxValue = 4096, .defaultValue = 0}, comptime width: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 4096, comptime defaultValue: comptime_float = 0} = .{.type = f32, .minValue = 0, .maxValue = 4096, .defaultValue = 0}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s18, {
  ...s,
  type: 11,
  name: "*const struct{comptime center: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 4096, comptime defaultValue: comptime_float = 0} = .{.type = f32, .minValue = 0, .maxValue = 4096, .defaultValue = 0}, comptime width: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 4096, comptime defaultValue: comptime_float = 0} = .{.type = f32, .minValue = 0, .maxValue = 4096, .defaultValue = 0}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a19 = new Uint8Array([ 184, 42, 16, 0 ]);
const a20 = new Uint8Array([ 111, 42, 16, 0 ]);
const a21 = new Uint8Array([ 110, 101, 116, 46, 110, 105, 99, 111, 112, 116, 101, 114, 101, 46, 102, 105, 108, 116, 101, 114, 115, 0 ]);
const a22 = new Uint8Array([ 180, 42, 16, 0 ]);
const a23 = new Uint8Array([ 91, 42, 16, 0 ]);
const a24 = new Uint8Array([ 110, 105, 99, 111, 112, 116, 101, 114, 101, 0 ]);
const a25 = new Uint8Array([ 176, 42, 16, 0 ]);
const a26 = new Uint8Array([ 1, 0, 0, 0 ]);
const a27 = new Uint8Array([ 172, 42, 16, 0 ]);
const a28 = new Uint8Array([ 67, 42, 16, 0 ]);
const a29 = new Uint8Array([ 109, 101, 114, 99, 97, 116, 111, 114, 0 ]);
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "mercator.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "mercator.KernelInput(u8,mercator.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s39, {
  ...s,
  type: 2,
  name: "mercator.KernelOutput(u8,mercator.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 2,
  name: "mercator.KernelParameters(mercator.kernel)",
  length: 1,
  byteSize: 8,
  instance: {
    members: [
...
Object.assign(s41, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(mercator.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s42, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(mercator.createOutput)).Fn.return_type.?).ErrorUnion.error_set!mercator.KernelOutput(u8,mercator.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s44, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(mercator.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s45, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(mercator.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!mercator.KernelOutput(u8,mercator.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_32cbfe8f;
  return fetch(url);
})();
