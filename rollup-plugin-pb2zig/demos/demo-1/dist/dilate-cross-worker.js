...
const a21 = new Uint8Array([ 102, 108, 97, 115, 104, 32, 99, 111, 109, 112, 97, 116, 105, 98, 108, 101, 32, 100, 105, 108, 97, 116, 101, 32, 102, 105, 108, 116, 101, 114, 32, 39, 99, 114, 111, 115, 115, 39, 0 ]);
...
Object.assign(s30, {
  ...s,
  type: 2,
  name: "dilate-cross.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "dilate-cross.KernelInput(u8,dilate-cross.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "dilate-cross.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "dilate-cross.KernelOutput(u8,dilate-cross.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s36, {
  ...s,
  type: 2,
  name: "dilate-cross.KernelParameters(dilate-cross.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-cross.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-cross.createOutput)).Fn.return_type.?).ErrorUnion.error_set!dilate-cross.KernelOutput(u8,dilate-cross.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-cross.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s41, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-cross.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!dilate-cross.KernelOutput(u8,dilate-cross.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_71332c42;
  return fetch(url);
})();
