...
const a11 = new Uint8Array([ 44, 10, 16, 0 ]);
const a12 = new Uint8Array([ 230, 9, 16, 0 ]);
const a13 = new Uint8Array([ 65, 73, 70, 0 ]);
const a14 = new Uint8Array([ 40, 10, 16, 0 ]);
const a15 = new Uint8Array([ 206, 9, 16, 0 ]);
const a16 = new Uint8Array([ 65, 100, 111, 98, 101, 32, 83, 121, 115, 116, 101, 109, 115, 0 ]);
const a17 = new Uint8Array([ 36, 10, 16, 0 ]);
const a18 = new Uint8Array([ 2, 0, 0, 0 ]);
const a19 = new Uint8Array([ 32, 10, 16, 0 ]);
const a20 = new Uint8Array([ 162, 9, 16, 0 ]);
const a21 = new Uint8Array([ 65, 32, 115, 105, 109, 112, 108, 101, 32, 102, 105, 120, 101, 100, 45, 115, 105, 122, 101, 32, 98, 111, 120, 32, 98, 108, 117, 114, 0 ]);
...
Object.assign(s25, {
  ...s,
  type: 9,
  name: "simple-box-blur.ColorSpace",
  length: 1,
  byteSize: 1,
  align: 0,
  instance: {
...
Object.assign(s30, {
  ...s,
  type: 2,
  name: "simple-box-blur.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "simple-box-blur.KernelInput(u8,simple-box-blur.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "simple-box-blur.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "simple-box-blur.KernelOutput(u8,simple-box-blur.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s36, {
  ...s,
  type: 2,
  name: "simple-box-blur.KernelParameters(simple-box-blur.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(simple-box-blur.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(simple-box-blur.createOutput)).Fn.return_type.?).ErrorUnion.error_set!simple-box-blur.KernelOutput(u8,simple-box-blur.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(simple-box-blur.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s41, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(simple-box-blur.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!simple-box-blur.KernelOutput(u8,simple-box-blur.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_37a71ae7;
  return fetch(url);
})();
