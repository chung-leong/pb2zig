...
const a22 = new Uint8Array([ 83, 111, 102, 116, 76, 105, 103, 104, 116, 32, 98, 108, 101, 110, 100, 32, 109, 111, 100, 101, 0 ]);
...
Object.assign(s27, {
  ...s,
  type: 2,
  name: "soft-light.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s28, {
  ...s,
  type: 2,
  name: "soft-light.KernelInput(u8,soft-light.kernel)",
  length: 1,
  byteSize: 48,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "soft-light.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s32, {
  ...s,
  type: 2,
  name: "soft-light.KernelOutput(u8,soft-light.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s33, {
  ...s,
  type: 2,
  name: "soft-light.KernelParameters(soft-light.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(soft-light.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(soft-light.createOutput)).Fn.return_type.?).ErrorUnion.error_set!soft-light.KernelOutput(u8,soft-light.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(soft-light.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(soft-light.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!soft-light.KernelOutput(u8,soft-light.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_c6c54e2b;
  return fetch(url);
})();
