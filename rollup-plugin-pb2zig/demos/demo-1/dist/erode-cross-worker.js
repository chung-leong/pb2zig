...
const a11 = new Uint8Array([ 228, 9, 16, 0 ]);
const a12 = new Uint8Array([ 150, 9, 16, 0 ]);
const a13 = new Uint8Array([ 99, 111, 109, 46, 103, 97, 115, 117, 98, 97, 115, 117, 0 ]);
const a14 = new Uint8Array([ 224, 9, 16, 0 ]);
const a15 = new Uint8Array([ 131, 9, 16, 0 ]);
const a16 = new Uint8Array([ 103, 97, 115, 117, 98, 97, 115, 117, 0 ]);
const a17 = new Uint8Array([ 220, 9, 16, 0 ]);
const a18 = new Uint8Array([ 1, 0, 0, 0 ]);
const a19 = new Uint8Array([ 216, 9, 16, 0 ]);
const a20 = new Uint8Array([ 78, 9, 16, 0 ]);
const a21 = new Uint8Array([ 102, 108, 97, 115, 104, 32, 99, 111, 109, 112, 97, 116, 105, 98, 108, 101, 32, 101, 114, 111, 100, 101, 32, 102, 105, 108, 116, 101, 114, 32, 39, 99, 114, 111, 115, 115, 39, 0 ]);
...
Object.assign(s30, {
  ...s,
  type: 2,
  name: "erode-cross.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "erode-cross.KernelInput(u8,erode-cross.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "erode-cross.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "erode-cross.KernelOutput(u8,erode-cross.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s36, {
  ...s,
  type: 2,
  name: "erode-cross.KernelParameters(erode-cross.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(erode-cross.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(erode-cross.createOutput)).Fn.return_type.?).ErrorUnion.error_set!erode-cross.KernelOutput(u8,erode-cross.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(erode-cross.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s41, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(erode-cross.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!erode-cross.KernelOutput(u8,erode-cross.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_4a002210;
  return fetch(url);
})();
