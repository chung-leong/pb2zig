...
const a7 = new Uint8Array([ 56, 30, 16, 0 ]);
Object.assign(s18, {
  ...s,
  type: 2,
...
const a16 = new Uint8Array([ 48, 30, 16, 0 ]);
Object.assign(s22, {
  ...s,
  type: 2,
...
const a27 = new Uint8Array([ 72, 30, 16, 0 ]);
...
const a35 = new Uint8Array([ 92, 53, 16, 0 ]);
const a36 = new Uint8Array([ 27, 53, 16, 0 ]);
const a37 = new Uint8Array([ 83, 112, 104, 101, 114, 101, 0 ]);
const a38 = new Uint8Array([ 88, 53, 16, 0 ]);
const a39 = new Uint8Array([ 9, 53, 16, 0 ]);
const a40 = new Uint8Array([ 77, 114, 46, 100, 111, 111, 98, 0 ]);
const a41 = new Uint8Array([ 84, 53, 16, 0 ]);
const a42 = new Uint8Array([ 1, 0, 0, 0 ]);
const a43 = new Uint8Array([ 80, 53, 16, 0 ]);
const a44 = new Uint8Array([ 236, 52, 16, 0 ]);
const a45 = new Uint8Array([ 83, 112, 104, 101, 114, 101, 32, 101, 102, 102, 101, 99, 116, 0 ]);
...
const a52 = new Uint8Array([ 72, 30, 16, 0 ]);
Object.assign(s45, {
  ...s,
  type: 2,
  name: "sphere.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "sphere.KernelInput(u8,sphere.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "sphere.KernelOutput(u8,sphere.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "sphere.KernelParameters(sphere.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(sphere.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(sphere.createOutput)).Fn.return_type.?).ErrorUnion.error_set!sphere.KernelOutput(u8,sphere.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(sphere.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(sphere.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!sphere.KernelOutput(u8,sphere.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_2049f6a1;
  return fetch(url);
})();
