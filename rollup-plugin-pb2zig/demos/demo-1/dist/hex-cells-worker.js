...
const a1 = new Uint8Array([ 200, 2, 16, 0 ]);
const a2 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 240, 63 ]);
const a3 = new Uint8Array([ 192, 2, 16, 0 ]);
const a4 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 105, 64 ]);
const a5 = new Uint8Array([ 184, 2, 16, 0 ]);
const a6 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 73, 64 ]);
const a7 = new Uint8Array([ 176, 2, 16, 0 ]);
const a8 = new Uint8Array([ 219, 2, 16, 0 ]);
const a9 = new Uint8Array([ 72, 101, 120, 97, 103, 111, 110, 32, 83, 105, 122, 101, 0 ]);
Object.assign(s18, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 1, comptime maxValue: comptime_float = 200, comptime defaultValue: comptime_float = 50, comptime description: *const [12:0]u8 = \"Hexagon Size\"}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s19, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 1, comptime maxValue: comptime_float = 200, comptime defaultValue: comptime_float = 50, comptime description: *const [12:0]u8 = \"Hexagon Size\"}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a11 = new Uint8Array([ 160, 2, 16, 0 ]);
const a12 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 105, 192 ]);
const a13 = new Uint8Array([ 160, 2, 16, 0 ]);
Object.assign(s21, {
  ...s,
  type: 2,
...
const a15 = new Uint8Array([ 152, 2, 16, 0 ]);
const a16 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 137, 64 ]);
const a17 = new Uint8Array([ 144, 2, 16, 0 ]);
const a18 = new Uint8Array([ 0, 0, 0, 0, 0, 64, 127, 64 ]);
Object.assign(s23, {
  ...s,
  type: 2,
...
const a21 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 121, 64 ]);
const a22 = new Uint8Array([ 128, 2, 16, 0 ]);
const a23 = new Uint8Array([ 0, 0, 0, 0, 0, 64, 111, 64 ]);
Object.assign(s25, {
  ...s,
  type: 2,
  name: "struct{comptime comptime_float = 400, comptime comptime_float = 250}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s26, {
  ...s,
  type: 11,
  name: "*const struct{comptime comptime_float = 400, comptime comptime_float = 250}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s32, {
  ...s,
  type: 2,
  name: "struct{comptime size: struct{comptime type: type = f32, comptime minValue: comptime_float = 1, comptime maxValue: comptime_float = 200, comptime defaultValue: comptime_float = 50, comptime description: *const [12:0]u8 = \"Hexagon Size\"} = .{.type = f32, .minValue = 1, .maxValue = 200, .defaultValue = 50, .description = \"Hexagon Size\"}, comptime base: struct{comptime type: type = @Vector(2, f32), comptime minValue: struct{comptime comptime_float = -200, comptime comptime_float = -200} = .{-200, -200}, comptime maxValue: struct{comptime comptime_float = 800, comptime comptime_float = 500} = .{800, 500}, comptime defaultValue: struct{comptime comptime_float = 400, comptime comptime_float = 250} = .{400, 250}, comptime description: *const [10:0]u8 = \"base point\"} = .{.type = @Vector(2, f32), .minValue = .{-200, -200}, .maxValue = .{800, 500}, .defaultValue = .{400, 250}, .description = \"base point\"}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s33, {
  ...s,
  type: 11,
  name: "*const struct{comptime size: struct{comptime type: type = f32, comptime minValue: comptime_float = 1, comptime maxValue: comptime_float = 200, comptime defaultValue: comptime_float = 50, comptime description: *const [12:0]u8 = \"Hexagon Size\"} = .{.type = f32, .minValue = 1, .maxValue = 200, .defaultValue = 50, .description = \"Hexagon Size\"}, comptime base: struct{comptime type: type = @Vector(2, f32), comptime minValue: struct{comptime comptime_float = -200, comptime comptime_float = -200} = .{-200, -200}, comptime maxValue: struct{comptime comptime_float = 800, comptime comptime_float = 500} = .{800, 500}, comptime defaultValue: struct{comptime comptime_float = 400, comptime comptime_float = 250} = .{400, 250}, comptime description: *const [10:0]u8 = \"base point\"} = .{.type = @Vector(2, f32), .minValue = .{-200, -200}, .maxValue = .{800, 500}, .defaultValue = .{400, 250}, .description = \"base point\"}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a36 = new Uint8Array([ 168, 2, 16, 0 ]);
...
Object.assign(s36, {
  ...s,
  type: 2,
  name: "struct{comptime img: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 11,
  name: "*const struct{comptime img: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a44 = new Uint8Array([ 16, 25, 16, 0 ]);
const a45 = new Uint8Array([ 181, 24, 16, 0 ]);
const a46 = new Uint8Array([ 72, 101, 120, 32, 99, 101, 108, 108, 115, 32, 239, 191, 189, 32, 110, 111, 116, 32, 106, 117, 115, 116, 32, 112, 105, 120, 101, 108, 115, 0 ]);
const a47 = new Uint8Array([ 12, 25, 16, 0 ]);
const a48 = new Uint8Array([ 156, 24, 16, 0 ]);
const a49 = new Uint8Array([ 80, 101, 116, 114, 105, 32, 76, 101, 115, 107, 105, 110, 101, 110, 0 ]);
const a50 = new Uint8Array([ 8, 25, 16, 0 ]);
const a51 = new Uint8Array([ 1, 0, 0, 0 ]);
const a52 = new Uint8Array([ 4, 25, 16, 0 ]);
const a53 = new Uint8Array([ 124, 24, 16, 0 ]);
const a54 = new Uint8Array([ 72, 101, 120, 97, 103, 111, 110, 97, 108, 32, 84, 105, 108, 105, 110, 103, 0 ]);
...
const a61 = new Uint8Array([ 168, 2, 16, 0 ]);
Object.assign(s49, {
  ...s,
  type: 2,
  name: "hex-cells.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "hex-cells.KernelInput(u8,hex-cells.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a68 = new Uint8Array([ 168, 2, 16, 0 ]);
Object.assign(s53, {
  ...s,
  type: 2,
  name: "hex-cells.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s54, {
  ...s,
  type: 2,
  name: "hex-cells.KernelOutput(u8,hex-cells.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a72 = new Uint8Array([ 0, 0, 200, 67, 0, 0, 122, 67, 0, 0, 72, 66, 0, 0, 0, 0 ]);
Object.assign(s55, {
  ...s,
  type: 2,
  name: "hex-cells.KernelParameters(hex-cells.kernel)",
  length: 1,
  byteSize: 16,
  align: 3,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(hex-cells.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s57, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(hex-cells.createOutput)).Fn.return_type.?).ErrorUnion.error_set!hex-cells.KernelOutput(u8,hex-cells.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s59, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(hex-cells.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s60, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(hex-cells.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!hex-cells.KernelOutput(u8,hex-cells.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const module = s62.constructor;

// initiate loading and compilation of WASM bytecodes
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_89ed35c2;
  return fetch(url);
})();
