...
const a35 = new Uint8Array([ 148, 53, 16, 0 ]);
const a36 = new Uint8Array([ 82, 53, 16, 0 ]);
const a37 = new Uint8Array([ 72, 121, 112, 110, 111, 116, 105, 99, 0 ]);
const a38 = new Uint8Array([ 144, 53, 16, 0 ]);
const a39 = new Uint8Array([ 64, 53, 16, 0 ]);
const a40 = new Uint8Array([ 77, 114, 46, 100, 111, 111, 98, 0 ]);
const a41 = new Uint8Array([ 140, 53, 16, 0 ]);
const a42 = new Uint8Array([ 1, 0, 0, 0 ]);
const a43 = new Uint8Array([ 136, 53, 16, 0 ]);
const a44 = new Uint8Array([ 33, 53, 16, 0 ]);
const a45 = new Uint8Array([ 72, 121, 112, 110, 111, 116, 105, 99, 32, 101, 102, 102, 101, 99, 116, 0 ]);
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "hypno.KernelInput(u8,hypno.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "hypno.KernelOutput(u8,hypno.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "hypno.KernelParameters(hypno.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(hypno.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(hypno.createOutput)).Fn.return_type.?).ErrorUnion.error_set!hypno.KernelOutput(u8,hypno.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(hypno.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(hypno.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!hypno.KernelOutput(u8,hypno.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_7708f23e;
  return fetch(url);
})();
