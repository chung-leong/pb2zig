...
const a9 = new Uint8Array([ 97, 109, 111, 117, 110, 116, 0 ]);
Object.assign(s18, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 5, comptime defaultValue: comptime_float = 0.5, comptime description: *const [6:0]u8 = \"amount\"}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s19, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 5, comptime defaultValue: comptime_float = 0.5, comptime description: *const [6:0]u8 = \"amount\"}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s20, {
  ...s,
  type: 2,
  name: "struct{comptime amount: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 5, comptime defaultValue: comptime_float = 0.5, comptime description: *const [6:0]u8 = \"amount\"} = .{.type = f32, .minValue = 0, .maxValue = 5, .defaultValue = 0.5, .description = \"amount\"}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s21, {
  ...s,
  type: 11,
  name: "*const struct{comptime amount: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 5, comptime defaultValue: comptime_float = 0.5, comptime description: *const [6:0]u8 = \"amount\"} = .{.type = f32, .minValue = 0, .maxValue = 5, .defaultValue = 0.5, .description = \"amount\"}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a22 = new Uint8Array([ 12, 42, 16, 0 ]);
const a23 = new Uint8Array([ 208, 41, 16, 0 ]);
const a24 = new Uint8Array([ 115, 109, 117, 100, 103, 101, 114, 0 ]);
const a25 = new Uint8Array([ 8, 42, 16, 0 ]);
const a26 = new Uint8Array([ 181, 41, 16, 0 ]);
const a27 = new Uint8Array([ 70, 114, 97, 110, 107, 32, 82, 101, 105, 116, 98, 101, 114, 103, 101, 114, 0 ]);
const a28 = new Uint8Array([ 4, 42, 16, 0 ]);
const a29 = new Uint8Array([ 1, 0, 0, 0 ]);
const a30 = new Uint8Array([ 0, 42, 16, 0 ]);
const a31 = new Uint8Array([ 138, 41, 16, 0 ]);
const a32 = new Uint8Array([ 103, 101, 110, 101, 114, 97, 116, 101, 115, 32, 97, 32, 115, 109, 117, 100, 103, 101, 100, 32, 112, 97, 116, 116, 101, 114, 110, 0 ]);
...
Object.assign(s38, {
  ...s,
  type: 2,
  name: "smudger.KernelInput(u8,smudger.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s42, {
  ...s,
  type: 2,
  name: "smudger.KernelOutput(u8,smudger.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a50 = new Uint8Array([ 0, 0, 0, 63 ]);
Object.assign(s43, {
  ...s,
  type: 2,
  name: "smudger.KernelParameters(smudger.kernel)",
  length: 1,
  instance: {
    members: [
      {
...
Object.assign(s44, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(smudger.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s45, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(smudger.createOutput)).Fn.return_type.?).ErrorUnion.error_set!smudger.KernelOutput(u8,smudger.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s47, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(smudger.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s48, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(smudger.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!smudger.KernelOutput(u8,smudger.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_701611d7;
  return fetch(url);
})();
