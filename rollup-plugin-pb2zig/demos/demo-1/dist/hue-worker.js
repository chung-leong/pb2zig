...
const a12 = new Uint8Array([ 96, 37, 16, 0 ]);
const a13 = new Uint8Array([ 36, 37, 16, 0 ]);
const a14 = new Uint8Array([ 70, 108, 97, 109, 101, 0 ]);
const a15 = new Uint8Array([ 92, 37, 16, 0 ]);
const a16 = new Uint8Array([ 20, 37, 16, 0 ]);
const a17 = new Uint8Array([ 65, 100, 111, 98, 101, 0 ]);
const a18 = new Uint8Array([ 88, 37, 16, 0 ]);
const a19 = new Uint8Array([ 1, 0, 0, 0 ]);
const a20 = new Uint8Array([ 84, 37, 16, 0 ]);
const a21 = new Uint8Array([ 246, 36, 16, 0 ]);
const a22 = new Uint8Array([ 72, 117, 101, 32, 98, 108, 101, 110, 100, 32, 109, 111, 100, 101, 0 ]);
...
Object.assign(s28, {
  ...s,
  type: 2,
  name: "hue.KernelInput(u8,hue.kernel)",
  length: 1,
  byteSize: 48,
  hasPointer: true,
  instance: {
...
Object.assign(s32, {
  ...s,
  type: 2,
  name: "hue.KernelOutput(u8,hue.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s33, {
  ...s,
  type: 2,
  name: "hue.KernelParameters(hue.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(hue.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(hue.createOutput)).Fn.return_type.?).ErrorUnion.error_set!hue.KernelOutput(u8,hue.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(hue.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(hue.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!hue.KernelOutput(u8,hue.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_6b4c3a72;
  return fetch(url);
})();
