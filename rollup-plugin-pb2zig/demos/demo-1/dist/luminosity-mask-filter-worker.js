...
const a1 = new Uint8Array([ 132, 2, 16, 0 ]);
...
Object.assign(s9, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = i32, comptime minValue: comptime_int = 0, comptime maxValue: comptime_int = 3, comptime defaultValue: comptime_int = 0}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s10, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = i32, comptime minValue: comptime_int = 0, comptime maxValue: comptime_int = 3, comptime defaultValue: comptime_int = 0}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s11, {
  ...s,
  type: 2,
  name: "struct{comptime mode: struct{comptime type: type = i32, comptime minValue: comptime_int = 0, comptime maxValue: comptime_int = 3, comptime defaultValue: comptime_int = 0} = .{.type = i32, .minValue = 0, .maxValue = 3, .defaultValue = 0}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s12, {
  ...s,
  type: 11,
  name: "*const struct{comptime mode: struct{comptime type: type = i32, comptime minValue: comptime_int = 0, comptime maxValue: comptime_int = 3, comptime defaultValue: comptime_int = 0} = .{.type = i32, .minValue = 0, .maxValue = 3, .defaultValue = 0}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s15, {
  ...s,
  type: 2,
  name: "struct{comptime mask: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s16, {
  ...s,
  type: 11,
  name: "*const struct{comptime mask: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a18 = new Uint8Array([ 204, 13, 16, 0 ]);
const a19 = new Uint8Array([ 126, 13, 16, 0 ]);
const a20 = new Uint8Array([ 70, 108, 97, 109, 101, 0 ]);
const a21 = new Uint8Array([ 200, 13, 16, 0 ]);
const a22 = new Uint8Array([ 110, 13, 16, 0 ]);
const a23 = new Uint8Array([ 65, 100, 111, 98, 101, 0 ]);
const a24 = new Uint8Array([ 132, 2, 16, 0 ]);
const a25 = new Uint8Array([ 196, 13, 16, 0 ]);
const a26 = new Uint8Array([ 61, 13, 16, 0 ]);
const a27 = new Uint8Array([ 76, 117, 109, 105, 110, 111, 115, 105, 116, 121, 32, 77, 97, 115, 107, 32, 102, 105, 108, 116, 101, 114, 32, 45, 32, 70, 108, 101, 120, 32, 83, 68, 75, 0 ]);
...
Object.assign(s19, {
  ...s,
  type: 2,
  name: "luminosity-mask-filter.kernel",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s24, {
  ...s,
  type: 9,
  name: "luminosity-mask-filter.ColorSpace",
  length: 1,
  byteSize: 1,
  align: 0,
  instance: {
...
const a34 = new Uint8Array([ 128, 2, 16, 0 ]);
Object.assign(s29, {
  ...s,
  type: 2,
  name: "luminosity-mask-filter.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s30, {
  ...s,
  type: 2,
  name: "luminosity-mask-filter.KernelInput(u8,luminosity-mask-filter.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a41 = new Uint8Array([ 128, 2, 16, 0 ]);
Object.assign(s33, {
  ...s,
  type: 2,
  name: "luminosity-mask-filter.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "luminosity-mask-filter.KernelOutput(u8,luminosity-mask-filter.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "luminosity-mask-filter.KernelParameters(luminosity-mask-filter.kernel)",
  length: 1,
  instance: {
    members: [
      {
...
Object.assign(s36, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(luminosity-mask-filter.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(luminosity-mask-filter.createOutput)).Fn.return_type.?).ErrorUnion.error_set!luminosity-mask-filter.KernelOutput(u8,luminosity-mask-filter.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s39, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(luminosity-mask-filter.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(luminosity-mask-filter.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!luminosity-mask-filter.KernelOutput(u8,luminosity-mask-filter.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const module = s42.constructor;

// initiate loading and compilation of WASM bytecodes
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_95d587fd;
  return fetch(url);
})();
