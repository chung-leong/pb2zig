...
const a36 = new Uint8Array([ 80, 53, 16, 0 ]);
const a37 = new Uint8Array([ 82, 97, 121, 115, 32, 50, 0 ]);
const a38 = new Uint8Array([ 140, 53, 16, 0 ]);
const a39 = new Uint8Array([ 62, 53, 16, 0 ]);
...
const a45 = new Uint8Array([ 82, 97, 121, 115, 32, 101, 102, 102, 101, 99, 116, 32, 50, 0 ]);
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "rays2.KernelInput(u8,rays2.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "rays2.KernelOutput(u8,rays2.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "rays2.KernelParameters(rays2.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(rays2.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(rays2.createOutput)).Fn.return_type.?).ErrorUnion.error_set!rays2.KernelOutput(u8,rays2.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(rays2.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(rays2.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!rays2.KernelOutput(u8,rays2.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_f5be5f3b;
  return fetch(url);
})();
