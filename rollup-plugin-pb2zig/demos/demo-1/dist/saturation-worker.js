...
const a22 = new Uint8Array([ 83, 97, 116, 117, 114, 97, 116, 105, 111, 110, 32, 98, 108, 101, 110, 100, 32, 109, 111, 100, 101, 0 ]);
...
Object.assign(s27, {
  ...s,
  type: 2,
  name: "saturation.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s28, {
  ...s,
  type: 2,
  name: "saturation.KernelInput(u8,saturation.kernel)",
  length: 1,
  byteSize: 48,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "saturation.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s32, {
  ...s,
  type: 2,
  name: "saturation.KernelOutput(u8,saturation.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s33, {
  ...s,
  type: 2,
  name: "saturation.KernelParameters(saturation.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(saturation.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(saturation.createOutput)).Fn.return_type.?).ErrorUnion.error_set!saturation.KernelOutput(u8,saturation.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(saturation.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(saturation.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!saturation.KernelOutput(u8,saturation.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_6d37cced;
  return fetch(url);
})();
