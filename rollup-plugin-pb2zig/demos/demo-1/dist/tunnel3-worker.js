...
const a35 = new Uint8Array([ 184, 53, 16, 0 ]);
const a36 = new Uint8Array([ 116, 53, 16, 0 ]);
const a37 = new Uint8Array([ 84, 117, 110, 110, 101, 108, 32, 51, 0 ]);
const a38 = new Uint8Array([ 180, 53, 16, 0 ]);
const a39 = new Uint8Array([ 98, 53, 16, 0 ]);
const a40 = new Uint8Array([ 77, 114, 46, 100, 111, 111, 98, 0 ]);
const a41 = new Uint8Array([ 176, 53, 16, 0 ]);
const a42 = new Uint8Array([ 1, 0, 0, 0 ]);
const a43 = new Uint8Array([ 172, 53, 16, 0 ]);
const a44 = new Uint8Array([ 67, 53, 16, 0 ]);
const a45 = new Uint8Array([ 84, 117, 110, 110, 101, 108, 32, 101, 102, 102, 101, 99, 116, 32, 51, 0 ]);
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "tunnel3.KernelInput(u8,tunnel3.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "tunnel3.KernelOutput(u8,tunnel3.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "tunnel3.KernelParameters(tunnel3.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel3.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel3.createOutput)).Fn.return_type.?).ErrorUnion.error_set!tunnel3.KernelOutput(u8,tunnel3.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel3.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(tunnel3.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!tunnel3.KernelOutput(u8,tunnel3.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_bff0365e;
  return fetch(url);
})();
