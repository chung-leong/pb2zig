...
const a6 = new Uint8Array([ 0, 0, 0, 0, 0, 0, 16, 64 ]);
Object.assign(s15, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 100, comptime defaultValue: comptime_float = 4}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s16, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 100, comptime defaultValue: comptime_float = 4}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s17, {
  ...s,
  type: 2,
  name: "struct{comptime strength: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 100, comptime defaultValue: comptime_float = 4} = .{.type = f32, .minValue = 0, .maxValue = 100, .defaultValue = 4}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s18, {
  ...s,
  type: 11,
  name: "*const struct{comptime strength: struct{comptime type: type = f32, comptime minValue: comptime_float = 0, comptime maxValue: comptime_float = 100, comptime defaultValue: comptime_float = 4} = .{.type = f32, .minValue = 0, .maxValue = 100, .defaultValue = 4}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a19 = new Uint8Array([ 252, 13, 16, 0 ]);
const a20 = new Uint8Array([ 181, 13, 16, 0 ]);
const a21 = new Uint8Array([ 112, 98, 50, 122, 105, 103, 0 ]);
const a22 = new Uint8Array([ 248, 13, 16, 0 ]);
const a23 = new Uint8Array([ 159, 13, 16, 0 ]);
const a24 = new Uint8Array([ 67, 104, 117, 110, 103, 32, 76, 101, 111, 110, 103, 0 ]);
const a25 = new Uint8Array([ 244, 13, 16, 0 ]);
const a26 = new Uint8Array([ 1, 0, 0, 0 ]);
const a27 = new Uint8Array([ 240, 13, 16, 0 ]);
const a28 = new Uint8Array([ 143, 13, 16, 0 ]);
const a29 = new Uint8Array([ 0 ]);
...
const a36 = new Uint8Array([ 128, 2, 16, 0 ]);
Object.assign(s34, {
  ...s,
  type: 2,
  name: "green-screen.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "green-screen.KernelInput(u8,green-screen.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a43 = new Uint8Array([ 128, 2, 16, 0 ]);
Object.assign(s38, {
  ...s,
  type: 2,
  name: "green-screen.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s39, {
  ...s,
  type: 2,
  name: "green-screen.KernelOutput(u8,green-screen.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a47 = new Uint8Array([ 0, 0, 128, 64 ]);
Object.assign(s40, {
  ...s,
  type: 2,
  name: "green-screen.KernelParameters(green-screen.kernel)",
  length: 1,
  instance: {
    members: [
      {
...
Object.assign(s41, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(green-screen.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s42, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(green-screen.createOutput)).Fn.return_type.?).ErrorUnion.error_set!green-screen.KernelOutput(u8,green-screen.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s44, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(green-screen.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s45, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(green-screen.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!green-screen.KernelOutput(u8,green-screen.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_acbc375b;
  return fetch(url);
})();
