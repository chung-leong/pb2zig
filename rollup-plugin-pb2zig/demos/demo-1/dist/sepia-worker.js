...
const a18 = new Uint8Array([ 120, 13, 16, 0 ]);
const a19 = new Uint8Array([ 59, 13, 16, 0 ]);
const a20 = new Uint8Array([ 65, 73, 70, 0 ]);
const a21 = new Uint8Array([ 116, 13, 16, 0 ]);
const a22 = new Uint8Array([ 35, 13, 16, 0 ]);
const a23 = new Uint8Array([ 65, 100, 111, 98, 101, 32, 83, 121, 115, 116, 101, 109, 115, 0 ]);
const a24 = new Uint8Array([ 112, 13, 16, 0 ]);
const a25 = new Uint8Array([ 2, 0, 0, 0 ]);
const a26 = new Uint8Array([ 108, 13, 16, 0 ]);
const a27 = new Uint8Array([ 252, 12, 16, 0 ]);
const a28 = new Uint8Array([ 97, 32, 118, 97, 114, 105, 97, 98, 108, 101, 32, 115, 101, 112, 105, 97, 32, 102, 105, 108, 116, 101, 114, 0 ]);
...
Object.assign(s41, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(sepia.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s42, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(sepia.createOutput)).Fn.return_type.?).ErrorUnion.error_set!sepia.KernelOutput(u8,sepia.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s44, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(sepia.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s45, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(sepia.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!sepia.KernelOutput(u8,sepia.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_b89a1e5f;
  return fetch(url);
})();
