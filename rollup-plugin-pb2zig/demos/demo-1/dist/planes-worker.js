...
const a1 = new Uint8Array([ 144, 2, 16, 0 ]);
...
const a7 = new Uint8Array([ 136, 2, 16, 0 ]);
Object.assign(s18, {
  ...s,
  type: 2,
...
const a16 = new Uint8Array([ 128, 2, 16, 0 ]);
Object.assign(s22, {
  ...s,
  type: 2,
...
const a35 = new Uint8Array([ 172, 25, 16, 0 ]);
const a36 = new Uint8Array([ 107, 25, 16, 0 ]);
const a37 = new Uint8Array([ 80, 108, 97, 110, 101, 115, 0 ]);
const a38 = new Uint8Array([ 168, 25, 16, 0 ]);
const a39 = new Uint8Array([ 89, 25, 16, 0 ]);
const a40 = new Uint8Array([ 77, 114, 46, 100, 111, 111, 98, 0 ]);
const a41 = new Uint8Array([ 164, 25, 16, 0 ]);
const a42 = new Uint8Array([ 1, 0, 0, 0 ]);
const a43 = new Uint8Array([ 160, 25, 16, 0 ]);
const a44 = new Uint8Array([ 60, 25, 16, 0 ]);
const a45 = new Uint8Array([ 80, 108, 97, 110, 101, 115, 32, 101, 102, 102, 101, 99, 116, 0 ]);
...
const a52 = new Uint8Array([ 152, 2, 16, 0 ]);
Object.assign(s45, {
  ...s,
  type: 2,
  name: "planes.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "planes.KernelInput(u8,planes.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a59 = new Uint8Array([ 152, 2, 16, 0 ]);
Object.assign(s49, {
  ...s,
  type: 2,
  name: "planes.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "planes.KernelOutput(u8,planes.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "planes.KernelParameters(planes.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(planes.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(planes.createOutput)).Fn.return_type.?).ErrorUnion.error_set!planes.KernelOutput(u8,planes.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(planes.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(planes.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!planes.KernelOutput(u8,planes.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_5fd35a40;
  return fetch(url);
})();
