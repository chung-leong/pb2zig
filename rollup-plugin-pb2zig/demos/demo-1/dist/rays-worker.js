...
const a35 = new Uint8Array([ 120, 53, 16, 0 ]);
const a36 = new Uint8Array([ 59, 53, 16, 0 ]);
const a37 = new Uint8Array([ 82, 97, 121, 115, 0 ]);
const a38 = new Uint8Array([ 116, 53, 16, 0 ]);
const a39 = new Uint8Array([ 41, 53, 16, 0 ]);
const a40 = new Uint8Array([ 77, 114, 46, 100, 111, 111, 98, 0 ]);
const a41 = new Uint8Array([ 112, 53, 16, 0 ]);
const a42 = new Uint8Array([ 1, 0, 0, 0 ]);
const a43 = new Uint8Array([ 108, 53, 16, 0 ]);
const a44 = new Uint8Array([ 14, 53, 16, 0 ]);
const a45 = new Uint8Array([ 82, 97, 121, 115, 32, 101, 102, 102, 101, 99, 116, 0 ]);
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "rays.KernelInput(u8,rays.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "rays.KernelOutput(u8,rays.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "rays.KernelParameters(rays.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(rays.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(rays.createOutput)).Fn.return_type.?).ErrorUnion.error_set!rays.KernelOutput(u8,rays.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(rays.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(rays.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!rays.KernelOutput(u8,rays.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_4b64b06f;
  return fetch(url);
})();
