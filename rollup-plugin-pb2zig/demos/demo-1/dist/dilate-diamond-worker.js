...
Object.assign(s16, {
  ...s,
  type: 2,
  name: "struct{comptime i: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s17, {
  ...s,
  type: 11,
  name: "*const struct{comptime i: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s18, {
  ...s,
  type: 2,
  name: "struct{comptime o: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s19, {
  ...s,
  type: 11,
  name: "*const struct{comptime o: struct{comptime channels: comptime_int = 4} = .{.channels = 4}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a11 = new Uint8Array([ 32, 10, 16, 0 ]);
const a12 = new Uint8Array([ 208, 9, 16, 0 ]);
const a13 = new Uint8Array([ 99, 111, 109, 46, 103, 97, 115, 117, 98, 97, 115, 117, 0 ]);
const a14 = new Uint8Array([ 28, 10, 16, 0 ]);
const a15 = new Uint8Array([ 189, 9, 16, 0 ]);
const a16 = new Uint8Array([ 103, 97, 115, 117, 98, 97, 115, 117, 0 ]);
const a17 = new Uint8Array([ 24, 10, 16, 0 ]);
const a18 = new Uint8Array([ 1, 0, 0, 0 ]);
const a19 = new Uint8Array([ 20, 10, 16, 0 ]);
const a20 = new Uint8Array([ 133, 9, 16, 0 ]);
const a21 = new Uint8Array([ 102, 108, 97, 115, 104, 32, 99, 111, 109, 112, 97, 116, 105, 98, 108, 101, 32, 100, 105, 108, 97, 116, 101, 32, 102, 105, 108, 116, 101, 114, 32, 39, 100, 105, 97, 109, 111, 110, 100, 39, 0 ]);
...
Object.assign(s25, {
  ...s,
  type: 9,
  name: "dilate-diamond.ColorSpace",
  length: 1,
  byteSize: 1,
  align: 0,
  instance: {
...
Object.assign(s30, {
  ...s,
  type: 2,
  name: "dilate-diamond.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "dilate-diamond.KernelInput(u8,dilate-diamond.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 2,
  name: "dilate-diamond.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 2,
  name: "dilate-diamond.KernelOutput(u8,dilate-diamond.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s36, {
  ...s,
  type: 2,
  name: "dilate-diamond.KernelParameters(dilate-diamond.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-diamond.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-diamond.createOutput)).Fn.return_type.?).ErrorUnion.error_set!dilate-diamond.KernelOutput(u8,dilate-diamond.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-diamond.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s41, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(dilate-diamond.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!dilate-diamond.KernelOutput(u8,dilate-diamond.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_9fadf52a;
  return fetch(url);
})();
