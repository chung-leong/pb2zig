...
const a12 = new Uint8Array([ 236, 37, 16, 0 ]);
const a13 = new Uint8Array([ 169, 37, 16, 0 ]);
const a14 = new Uint8Array([ 70, 108, 97, 109, 101, 0 ]);
const a15 = new Uint8Array([ 232, 37, 16, 0 ]);
const a16 = new Uint8Array([ 153, 37, 16, 0 ]);
const a17 = new Uint8Array([ 65, 100, 111, 98, 101, 0 ]);
const a18 = new Uint8Array([ 228, 37, 16, 0 ]);
const a19 = new Uint8Array([ 1, 0, 0, 0 ]);
const a20 = new Uint8Array([ 224, 37, 16, 0 ]);
const a21 = new Uint8Array([ 117, 37, 16, 0 ]);
const a22 = new Uint8Array([ 67, 111, 108, 111, 114, 66, 117, 114, 110, 32, 98, 108, 101, 110, 100, 32, 109, 111, 100, 101, 0 ]);
...
Object.assign(s27, {
  ...s,
  type: 2,
  name: "color-burn.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s28, {
  ...s,
  type: 2,
  name: "color-burn.KernelInput(u8,color-burn.kernel)",
  length: 1,
  byteSize: 48,
  hasPointer: true,
  instance: {
...
Object.assign(s31, {
  ...s,
  type: 2,
  name: "color-burn.Image(u8,4,true)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s32, {
  ...s,
  type: 2,
  name: "color-burn.KernelOutput(u8,color-burn.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s33, {
  ...s,
  type: 2,
  name: "color-burn.KernelParameters(color-burn.kernel)",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s34, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(color-burn.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s35, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(color-burn.createOutput)).Fn.return_type.?).ErrorUnion.error_set!color-burn.KernelOutput(u8,color-burn.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(color-burn.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s38, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(color-burn.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!color-burn.KernelOutput(u8,color-burn.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_3ba18102;
  return fetch(url);
})();
