...
const a35 = new Uint8Array([ 144, 53, 16, 0 ]);
const a36 = new Uint8Array([ 72, 53, 16, 0 ]);
const a37 = new Uint8Array([ 89, 111, 117, 114, 32, 78, 97, 109, 101, 115, 112, 97, 99, 101, 0 ]);
const a38 = new Uint8Array([ 140, 53, 16, 0 ]);
const a39 = new Uint8Array([ 50, 53, 16, 0 ]);
const a40 = new Uint8Array([ 89, 111, 117, 114, 32, 86, 101, 110, 100, 111, 114, 0 ]);
const a41 = new Uint8Array([ 136, 53, 16, 0 ]);
const a42 = new Uint8Array([ 1, 0, 0, 0 ]);
const a43 = new Uint8Array([ 132, 53, 16, 0 ]);
const a44 = new Uint8Array([ 18, 53, 16, 0 ]);
const a45 = new Uint8Array([ 121, 111, 117, 114, 32, 100, 101, 115, 99, 114, 105, 112, 116, 105, 111, 110, 0 ]);
...
Object.assign(s46, {
  ...s,
  type: 2,
  name: "star.KernelInput(u8,star.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s50, {
  ...s,
  type: 2,
  name: "star.KernelOutput(u8,star.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s51, {
  ...s,
  type: 2,
  name: "star.KernelParameters(star.kernel)",
  length: 1,
  byteSize: 24,
  align: 3,
  instance: {
...
Object.assign(s52, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(star.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s53, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(star.createOutput)).Fn.return_type.?).ErrorUnion.error_set!star.KernelOutput(u8,star.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s55, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(star.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s56, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(star.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!star.KernelOutput(u8,star.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_4fb2d6ba;
  return fetch(url);
})();
