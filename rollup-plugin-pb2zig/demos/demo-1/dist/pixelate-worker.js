...
const a4 = new Uint8Array([ 100, 0, 0, 0 ]);
const a5 = new Uint8Array([ 132, 2, 16, 0 ]);
Object.assign(s12, {
  ...s,
  type: 2,
  name: "struct{comptime type: type = i32, comptime minValue: comptime_int = 1, comptime maxValue: comptime_int = 100, comptime defaultValue: comptime_int = 1}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s13, {
  ...s,
  type: 11,
  name: "*const struct{comptime type: type = i32, comptime minValue: comptime_int = 1, comptime maxValue: comptime_int = 100, comptime defaultValue: comptime_int = 1}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
Object.assign(s14, {
  ...s,
  type: 2,
  name: "struct{comptime dimension: struct{comptime type: type = i32, comptime minValue: comptime_int = 1, comptime maxValue: comptime_int = 100, comptime defaultValue: comptime_int = 1} = .{.type = i32, .minValue = 1, .maxValue = 100, .defaultValue = 1}}",
  length: 1,
  byteSize: 0,
  align: 0,
  instance: {
...
Object.assign(s15, {
  ...s,
  type: 11,
  name: "*const struct{comptime dimension: struct{comptime type: type = i32, comptime minValue: comptime_int = 1, comptime maxValue: comptime_int = 100, comptime defaultValue: comptime_int = 1} = .{.type = i32, .minValue = 1, .maxValue = 100, .defaultValue = 1}}",
  length: 1,
  isConst: true,
  hasPointer: true,
  instance: {
...
const a18 = new Uint8Array([ 36, 13, 16, 0 ]);
const a19 = new Uint8Array([ 228, 12, 16, 0 ]);
const a20 = new Uint8Array([ 65, 73, 70, 0 ]);
const a21 = new Uint8Array([ 32, 13, 16, 0 ]);
const a22 = new Uint8Array([ 204, 12, 16, 0 ]);
const a23 = new Uint8Array([ 65, 100, 111, 98, 101, 32, 83, 121, 115, 116, 101, 109, 115, 0 ]);
const a24 = new Uint8Array([ 28, 13, 16, 0 ]);
const a25 = new Uint8Array([ 2, 0, 0, 0 ]);
const a26 = new Uint8Array([ 24, 13, 16, 0 ]);
const a27 = new Uint8Array([ 171, 12, 16, 0 ]);
const a28 = new Uint8Array([ 112, 105, 120, 101, 108, 97, 116, 101, 32, 97, 110, 32, 105, 109, 97, 103, 101, 0 ]);
...
Object.assign(s32, {
  ...s,
  type: 2,
  name: "pixelate.Image(u8,4,false)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s33, {
  ...s,
  type: 2,
  name: "pixelate.KernelInput(u8,pixelate.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
Object.assign(s37, {
  ...s,
  type: 2,
  name: "pixelate.KernelOutput(u8,pixelate.kernel)",
  length: 1,
  byteSize: 24,
  hasPointer: true,
  instance: {
...
const a46 = new Uint8Array([ 1, 0, 0, 0 ]);
Object.assign(s38, {
  ...s,
  type: 2,
  name: "pixelate.KernelParameters(pixelate.kernel)",
  length: 1,
  instance: {
    members: [
      {
...
Object.assign(s39, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(pixelate.createOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s40, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(pixelate.createOutput)).Fn.return_type.?).ErrorUnion.error_set!pixelate.KernelOutput(u8,pixelate.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
Object.assign(s42, {
  ...s,
  type: 8,
  name: "@typeInfo(@typeInfo(@TypeOf(pixelate.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set",
  length: 1,
  byteSize: 2,
  align: 1,
  instance: {
...
Object.assign(s43, {
  ...s,
  type: 7,
  name: "@typeInfo(@typeInfo(@TypeOf(pixelate.createPartialOutput)).Fn.return_type.?).ErrorUnion.error_set!pixelate.KernelOutput(u8,pixelate.kernel)",
  length: 1,
  byteSize: 28,
  hasPointer: true,
  instance: {
...
const wasmPromise = (async () => {
  const url = import.meta.ROLLUP_FILE_URL_98d1ae54;
  return fetch(url);
})();
