...
// vendor: gasubasu
// version: 1
// description: flash compatible erode filter 'diamond'
...
pub const kernel = struct {
    ...
    fn Instance(comptime InputStruct: type) type {
        return struct {
            i: std.meta.fieldInfo(InputStruct, .i).type,
            ...
            pub fn evaluatePixel(self: @This(), outCoord: @Vector(2, f32)) @Vector(4, f32) {
                ...
                // output variable
                var o: @Vector(4, f32) = undefined;
                
                var c: @Vector(2, f32) = outCoord;
                var p: @Vector(2, f32) = undefined;
                var n: @Vector(4, f32) = undefined;
                o = @Vector(4, f32){ 1.0, 1.0, 1.0, 1.0 };
