    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                div = 21.0 / 20.0 * size;
                var p: @Vector(2, f32) = base2 + matrixCalc("*", matrixCalc("*", rot2r, div), (floor(matrixCalc("*", rot2, (self.outCoord() - base2)) / @as(@Vector(2, f32), @splat(div))) + @as(@Vector(2, f32), @splat(0.5))));
