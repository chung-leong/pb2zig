...
pub const kernel = struct {
    ...
    pub const parameters = .{
        .color1 = .{
            ...
            .defaultValue = .{ 0.441, 0.5859375, 0.62109375, 1.0 },
        ...
        .color2 = .{
            ...
            .minValue = .{ 0.0, 0.0, 0.0, 0.0 },
            .maxValue = .{ 1.0, 1.0, 1.0, 1.0 },
            .defaultValue = .{ 0.839, 0.101, 0.1289, 1.0 },
            .parameterType = "colorRGBA",
        },
        .color3 = .{
            .type = @Vector(4, f32),
        ...
        .color4 = .{
            ...
            .minValue = .{ 0.0, 0.0, 0.0, 0.0 },
            .maxValue = .{ 1.0, 1.0, 1.0, 1.0 },
            .defaultValue = .{ 0.983, 0.89, 0.656, 1.0 },
            .parameterType = "colorRGBA",
        },
        .color5 = .{
            .type = @Vector(4, f32),
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                const numColors = self.input.numColors;
                const color3 = self.input.color3;
                const color4 = self.input.color4;
                const color5 = self.input.color5;
                const color6 = self.input.color6;
                const color7 = self.input.color7;
                const color8 = self.input.color8;
