    ...
    fn Instance(comptime InputStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: @This(), outCoord: @Vector(2, f32)) @Vector(4, f32) {
                // input variables
                const difference = self.difference;
                ...
                var srcpos: @Vector(2, f32) = outCoord;
                ...
                if (maxdistance > difference[0]) {
                    ...
                    if (maxdistance > difference[1]) {
                        dst = bgcolor + (color - bgcolor) * @as(@Vector(4, f32), @splat(((maxdistance - difference[1]) / (difference[0] - difference[1]))));
                    } else {
                        dst = bgcolor;
                    }
                }
