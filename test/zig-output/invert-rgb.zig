    ...
    fn Instance(comptime InputStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: @This(), outCoord: @Vector(2, f32)) @Vector(4, f32) {
                ...
                var inputColor: @Vector(4, f32) = src.sampleNearest(outCoord);
                dst = @shuffle(f32, dst, @Vector(3, f32){ 1.0, 1.0, 1.0 } - @shuffle(f32, inputColor, undefined, @Vector(3, i32){ 0, 1, 2 }), @Vector(4, i32){ -1, -2, -3, 3 });
                dst[3] = inputColor[3];
                return dst;
            }
        };
