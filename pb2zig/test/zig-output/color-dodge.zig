// Pixel Bender kernel "ColorDodge" (translated using pb2zig)
...
pub const kernel = struct {
    ...
    pub const version = 1;
    pub const description = "ColorDodge blend mode";
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                if (cb[0] == 0.0) {
                    blendResult[0] = 0.0;
                } else if (cb[0] >= (1.0 - cs[0])) {
                    blendResult[0] = 1.0;
                } else {
                    blendResult[0] = cb[0] / (1.0 - cs[0]);
                }
                if (cb[1] == 0.0) {
                    blendResult[1] = 0.0;
                } else if (cb[1] >= (1.0 - cs[1])) {
                    blendResult[1] = 1.0;
                } else {
                    blendResult[1] = cb[1] / (1.0 - cs[1]);
                }
                if (cb[2] == 0.0) {
                    blendResult[2] = 0.0;
                } else if (cb[2] >= (1.0 - cs[2])) {
                    blendResult[2] = 1.0;
                } else {
                    blendResult[2] = cb[2] / (1.0 - cs[2]);
                }
