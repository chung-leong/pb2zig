...
pub const kernel = struct {
    // kernel information
    pub const namespace = "Sphere";
    pub const vendor = "Mr.doob";
    pub const version = 1;
    pub const description = "Sphere effect";
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                u += offset[0];
                v += offset[1];
                u += pos[0] * (3.0 - sqrt(4.0 - 5.0 * r * r)) / (r * r + 1.0);
                v += pos[1] * (3.0 - sqrt(4.0 - 5.0 * r * r)) / (r * r + 1.0);
                w += 1.7 * (pos[0] + pos[1] + r * r - (pos[0] + pos[1] - 1.0) * sqrt(4.0 - 5.0 * r * r) / 3.0) / (r * r + 1.0);
                u *= imgSize[0];
                v *= imgSize[1];
                if (u < 0.0) {
