// Pixel Bender kernel "CheckerFill" (translated using pb2zig)
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                const checkerSize = self.params.checkerSize;
                const colorA = self.params.colorA;
                const colorB = self.params.colorB;
