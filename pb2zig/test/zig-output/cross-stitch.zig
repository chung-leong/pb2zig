// Pixel Bender kernel "CrossStitch" (translated using pb2zig)
const std = @import("std");

pub const kernel = struct {
    // kernel information
    pub const namespace = "net.ghostradio.pb";
    pub const vendor = "ghostRadio.net";
    pub const version = 1;
    pub const description = "Cross-stitch effect";
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                const outputPx = self.output.outputPx;
                self.outputPx = @splat(0.0);

                const cPos: @Vector(2, f32) = self.outCoord();
                ...
                const remX: i32 = @intFromFloat(mod(cPos[0], @as(f32, @floatFromInt(size))));
                const remY: i32 = @intFromFloat(mod(cPos[1], @as(f32, @floatFromInt(size))));
                ...
                outputPx.writePixel(self.outputCoord, self.outputPx);
            }
