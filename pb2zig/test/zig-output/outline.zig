    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                const difference = self.params.difference;
                ...
                if (maxdistance > difference[0]) {
                    ...
                    self.dst = bgcolor + (color - bgcolor) * @as(@Vector(4, f32), @splat(((maxdistance - difference[1]) / (difference[0] - difference[1]))));
                } else {
                    self.dst = bgcolor;
                }
