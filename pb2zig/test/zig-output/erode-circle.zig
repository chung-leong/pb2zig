// Pixel Bender kernel "Erode_circle" (translated using pb2zig)
...
pub const kernel = struct {
    ...
    pub const version = 1;
    pub const description = "flash compatible erode filter 'circle'";
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                o.writePixel(self.outputCoord, self.o);
            }
