// Pixel Bender kernel "untitled" (translated using pb2zig)
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                const c1: @Vector(2, f32) = self.outCoord();
                var c2: @Vector(2, f32) = undefined;
                if (c1[1] == 0.5) {
                    c2 = @Vector(2, f32){ 10.5, 10.5 };
                } else if (c1[1] < 50.0) {
                    c2 = @Vector(2, f32){ 9.5, 9.5 };
                } else if (c1[1] < 100.0) {
                    c2 = @Vector(2, f32){ 9.5, 10.0 };
                } else if (c1[1] < 150.0) {
                    c2 = @Vector(2, f32){ 10.0, 10.0 };
                } else if (c1[1] < 200.0) {
                    c2 = @Vector(2, f32){ 10.5, 10.0 };
                } else if (c1[1] < 250.0) {
                    c2 = @Vector(2, f32){ 10.5, 10.5 };
                } else if (c1[1] < 300.0) {
                    c2 = @Vector(2, f32){ 10.25, 10.25 };
                } else if (c1[1] < 350.0) {
                    c2 = @Vector(2, f32){ 10.75, 10.75 };
                } else {
                    c2 = @Vector(2, f32){ 9.75, 9.75 };
                }
                self.dst = src.sampleLinear(c2);
