// Pixel Bender kernel "Color" (translated using pb2zig)
...
pub const kernel = struct {
    ...
    pub const version = 1;
    pub const description = "Color blend mode";
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                const adjVec: @Vector(3, f32) = (cb - cs);
                const adjustment: f32 = luminance(adjVec);
                const adjustedcs: @Vector(3, f32) = cs + @as(@Vector(3, f32), @splat(adjustment));
