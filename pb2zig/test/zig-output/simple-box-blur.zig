// Pixel Bender kernel "SimpleBoxBlur" (translated using pb2zig)
    ...
    fn Instance(comptime InputStruct: type, comptime OutputStruct: type, comptime ParameterStruct: type) type {
        return struct {
            ...
            pub fn evaluatePixel(self: *@This()) void {
                ...
                var colorAccumulator: @Vector(4, f32) = .{ 0.0, 0.0, 0.0, 0.0 };
                const singlePixel: @Vector(2, f32) = src.pixelSize();
                colorAccumulator += src.sampleNearest(self.outCoord() + @Vector(2, f32){
                    -singlePixel[0],
                    -singlePixel[1],
                });
                denominator += 1.0;
